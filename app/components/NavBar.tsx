        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <Link href="/sign-in" className="px-3 py-2 rounded-md text-sm font-medium bg-purple-600 hover:bg-purple-700 transition duration-300">
                Iniciar Sesión
              </Link>
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href="/sign-in" className="block px-3 py-2 rounded-md text-base font-medium text-white bg-purple-600 hover:bg-purple-700 transition duration-300">
              Iniciar Sesión
            </Link>
          </div>
        </div>
